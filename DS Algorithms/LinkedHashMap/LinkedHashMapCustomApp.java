...
public class LinkedHashMapCustomApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nvalue corresponding to key 21=" + linkedHashMapCustom.get(21));
		System.out.println("\nvalue corresponding to key 51=" + linkedHashMapCustom.get(51));

		System.out.println("\nvalue corresponding to key 21 removed: " + linkedHashMapCustom.remove(21));
		System.out.println("\nvalue corresponding to key 22 removed: " + linkedHashMapCustom.remove(22));
